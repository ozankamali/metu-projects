...
##########################################################
# I have implemented the cmpq instruction just like in 
# PART B. ICMPQ is added to need_regids, srcA, srcB, 
# aluA, aluB and ALUSUB is used for the updates of the  
# condition codes. 
# Basically same as PART2
##########################################################
